...
export interface CareerMetrics {
  ...
  RIDERSHIP_PERCENTAGE: 'ridership_percentage';
  ...
  PASSENGERS_BETWEEN_REGIONS: 'passengers_between_regions';
  PASSENGERS_FROM_REGION: 'passengers_from_region';
  PASSENGERS_TO_REGION: 'passengers_to_region';
  STATIONS_IN_REGION: 'stations_in_region';
}
...
export interface ModdingAPI {
  ...
  ui: {
    ...
    addToolbarButton(options: UIToolbarButtonOptions): void;
